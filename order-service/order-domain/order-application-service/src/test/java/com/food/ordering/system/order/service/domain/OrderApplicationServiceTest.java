...
public class OrderApplicationServiceTest {
    ...
    private final UUID CUSTOMER_ID = UUID.fromString("2c34e266-fa53-11ed-be56-0242ac120002");
    private final UUID ORDER_ID = UUID.fromString("7fea23d0-fa53-11ed-be56-0242ac120002");
    private final UUID RESTAURANT_ID = UUID.fromString("987c9b6c-fa53-11ed-be56-0242ac120002");
    private final UUID PRODUCT_ID = UUID.fromString("b375ebda-fa53-11ed-be56-0242ac120002");
    ...
    public void testCreateOrderWithWrongTotalPrice() {
        OrderDomainException orderDomainException
                ...
                () -> applicationService.createOrder(createOrderCommandWrongPrice));
    ...
    public void testCreateOrderWithWrongProductPrice() {
        OrderDomainException orderDomainException
                = assertThrows(OrderDomainException.class,
                () -> applicationService.createOrder(createOrderCommandWrongProductPrice));
    ...
    public void testCreateOrderWithPassiveRestaurant() {
        ...
        OrderDomainException orderDomainException
                = assertThrows(OrderDomainException.class, () -> applicationService.createOrder(createOrderCommand));
